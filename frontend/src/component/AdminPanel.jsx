...
// Zod schema remains the same, it's well-defined.
...
// A helper array for our new tabbed interface
...
function AdminPanel() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      navigate('/'); // Or navigate to the new problem's page
    } catch (error) {
  ...
  // Helper component for cleaner code inputs
    ...
    <div className="container mx-auto p-4 md:p-8 bg-base-200 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-primary">Create New Problem</h1>
          <p className="text-base-content/70">Fill out the details below to add a new problem to the platform.</p>
        </header>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="card bg-base-100 shadow-xl">
           ...
           <div className="form-control">
                ...
                <textarea {...register('Constraints')} className={`textarea textarea-bordered h-32 `} placeholder='Fill constraints for the problems, separated by commas' />
                {errors.Constraints && <label className="label"><span className="label-text-alt text-error">{errors.description.message}</span></label>}
              </div>
